...
const Index = () => {
  ...
  const formatPuncts = (puncts: string[] | null) => {
    ...
    return puncts.map((punct) => `${punct}`).join(" ");
  };
  ...
  return (
    <div className={styles.index}>
          ...
          <div className={styles.subpanel}>
              ...
              {state.showHome && !state.showSobre && !state.showStatistic && (
                <>
                  ...
                  <div className={styles.knowmore}>
                    <Button onClick={handleSobre}>
                      saber mais sobre essa porra
                    </Button>
                  </div>
                          ...
                          <div className={styles.lascou}>
                            <div className={styles.lascou_main}>
                              ...
                              <p>
                                ...
                                <span>
                                  {" "}
                                  não foi encontrada na nossa lista de verbos
                                  válidos. Gostaria de solicitar sua inclusão?
                                </span>
                              </p>
                              <div>
                                <Button
                                  onClick={() =>
                                    handleSolicitar(state.inputReq)
                                  }
                                >
                                  solicitar
                                </Button>
                            ...
                            <div className={styles.lascou_main}>
                              ...
                              <p>
                                ...
                                <span>
                                  ...
                                  diferenças formais. Por isso, você pode
                                  escolher qual forma conjugar, clicando no
                                  palavra desejada:
                                </span>
                              </p>
                              <div>
                          ...
                          <div className={styles.lascou}>
                            <div className={styles.lascou_main}>
                              ...
                              <p>
                                ...
                                <span>
                                  {" "}
                                  Caso queira conjugá-lo, clique no botão abaixo
                                </span>
                              </p>
                              <div>
                                <Button
                                  ref={buttonRef}
                                  onClick={() => {
                                    handleVerbClick(state.foundVerb as string);
                                  }}
                                >
                                  {state.foundVerb}
                                </Button>
                          ...
                          <div className={styles.lascou}>
                            <div className={styles.lascou_main}>
                              ...
                              <p>
                                <span>[err 21] </span>
                                <span>
                                  Infelizmente a lista de vocábulos do
                                  LibreOffice não possui todas as formas verbais
                                  prefixadas. Por isso, não encontramos a
                                  palavra{" "}
                                </span>
                                <span>
                                  <strong>'{state.inputReq}'</strong>
                            ...
                            <div className={styles.lascou_main}>
                              ...
                              <p>
                                ...
                                <span>
                                  ...
                                  Clique no botão da palavra que gostaria de
                                  conjugar:
                                </span>
                              </p>
                              <div>
            ...
            <Suspense fallback={null}>
              {state.conjugations !== null &&
                state.foundVerb &&
                (nw(
                  String(state.conjugations.canonical1.inf.p3).replace("*", ""),
                      ...
                      >
                        ...
                        {state.types && (
                          <p>
                            ...
                            {state.foundVerb.toLocaleLowerCase() === "lular" ? (
                              <span>
                                Maior presidente da história do Brasil
                              </span>
                            ) : (
      ...
      <section className={styles.foot_info}>
        <div className={styles.foot_info_div}>{mounted && <Socials />}</div>
