...
no desenvolvimento de aplicações e coisas afins. sim, é possível usar o buscador
oficial do VOLP no site oficial da ABL, mas esse tipo de acesso é bastante limitado
