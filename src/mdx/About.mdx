...
por essa razão, todas as 19 mil entradas estão sendo confrontadas
com o elenco de verbos constantes do Dicionário Houiass de Conjugação
de Verbos¹, um processo trabalhoso mas necessário.
esse trabalho é inescapável, especialmente quando buscamos existir por nós mesmos,
...
para que os verbos solicitados pelos visitantes sejam incluídos neste conjugador,
apenas dois critérios deverão ser atendidos:

1. constar no [VOLP](https://www.academia.org.br/nossa-lingua/busca-no-vocabulario)
2. ter uma regra de conjugação associada ao verbo no Dicionário Houaiss de Conjugação de Verbos[^1]
...
**Morfologia do verbo português em obras de referência**[^2]
...
[^2]: Link para o Domínio Público: [http://www.dominiopublico.gov.br/pesquisa/DetalheObraForm.do?select_action=&co_obra=139897](http://www.dominiopublico.gov.br/pesquisa/DetalheObraForm.do?select_action=&co_obra=139897). 
