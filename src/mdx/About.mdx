...
não é possível usar o Vocabulário Ortográfico da Língua Portuguesa (VOLP) 
para o desenvolvimento de aplicações e coisas afins. sim, há um buscador
do VOLP no site oficial da ABL, mas esse tipo de acesso limita severamente 
as possibilidades de uso do seu conteúdo, 
seja para pesquisa científica, seja para o desenvolvimento de tecnologias ou softwares
baseados na nossa própria língua. frente a isso, foi necessário buscar outros meios, 
a exemplo da base de vocábulos da língua portuguesa brasileira 
do projeto VERO do LibreOffice. esse projeto disponibiliza uma base
de vocábulos da língua portuguesa bastante robusta, a qual pode ser acessada
...
terminam em "ar", "er", "ir" e "or". na etapa inicial, foram identificados 
...
pode-se reduzir a lista para pouco mais de 19 mil verbos no total (para 
saber mais, veja **dados**).
