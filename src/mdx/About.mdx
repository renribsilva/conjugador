...
### foda-se a Acaademia Brasileira de Letras (ABL)
...
A língua portuguesa é um patrimônio coletivo, uma ferramenta cultural e social
fundamental, mas a ABL a trata como propriedade privada. Por isso,
é preciso dizer com todas em bom poturguês, ou em boas "letras: 
vai se foder, porra. 
...
Ela pode ser utilizada, por exemplo, no desenvolvimento de ferramentas como conjugadores
...
revisão ou inserção na base de dados. E só isso! Nada é coletado sem a sua ação explícita.
Para colaborações mais elaboradas, você pode entrar em contato comigo através 
...
O objetivo aqui é conjugar a porra de um verbo, nada mais. Não é vender porra nada,
...
utilizada para apoiar seu desenvolvimento. Destaco, então, o trabalho acadêmico de
