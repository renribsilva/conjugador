...
Dicionário Houaiss de Conjugação de Verbos[^1] registra pouco mais de 15 mil verbos. 
isso significa que há na nossa lista palavras que, embora 
terminem em "ar", "er", "ir" ou "or", podem não ser verbo. 
assim, o esforço para refinar essa lista é constante. No último levantamento[^2]
...
esse cenário evidencia que só o tempo poderá tornar este conjugador cada dias
melhor. aqui, não tem como escapar a 
esse trabalho, especialmente quando buscamos existir por nós mesmos,
sem precisar bater continência para nenhum fardão da ABL ou quem quer
que seja.
...
com conjugadores que já têm as conjugações prontas e só precisa exibi-las. 
...
### critérios de inclusão de novos verbos

para que os verbos solicitados pelos visitantes serão incluídos neste conjugador,
apenas dois critérios deverão ser atendidos:

1. constar no [VOLP](https://www.academia.org.br/nossa-lingua/busca-no-vocabulario)
2. ter uma regra de conjugação associada ao verbo no 
[Dicionário Online Houiass](https://houaiss.online/houaisson/apps/uol_www/v7-0/html/index.php) ou
no Dicionário Houaiss de Conjugação de Verbos[^1]
...
_Morfologia do verbo português em obras de referência_[^3],
...
[^2]: Data do último levantamento: 28 de nov. de 2024
