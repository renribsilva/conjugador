...
foram identificados aproximadamente 23 mil vocábulos. no entanto, nem todas as 23 mil palavras 
com essas terminações são, de fato, verbos. por essa razão, foi necessário
...
de Verbos[^1] e o já mencionado VOLP[^2]. esse processo extremamente
trabalhoso mas necessário, pois se insere num contexto em que
buscamos existir por nós mesmos.
