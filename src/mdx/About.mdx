...
embora terminem em "ar", "er", "ir" ou "or", podem não ser verbos. Para se 
ter uma dimensão do que isso quer dizer[^1]: 

1. Quantidade de entradas terminadas em 'ar': 16252[^2]
2. Quantidade de entradas terminadas em 'er': 1349
3. Quantidade de entradas terminadas em 'ir': 962
4. Quantidade de entradas terminadas em 'por': 52

ainda assim, é preferível pecar pelo excesso do que pela falta. 
esse cenário evidencia que será necessário tempo e para refinar a base 
de verbos, tornando-a cada vez mais precisa. aqui, não tem como escapar a 
esse é um trabalho, especialmente quando buscamos existir por nós mesmos.
...
[^1]: Atualizado pela última vez em 21 de nov. de 2024
[^2]: Salum, em _[Morfologia do verbo português em obras de referência](https://doi.org/10.11606/T.8.2007.tde-04102007-143455)_,
de 2007, aponta que os registros da obra de Houaiss encerram cerca de 13 mil 
