...
quais eram de fato verbos e quais não eram, utilizando duas referências
ortográficas: o Dicionário Houiass de Conjugação de Verbos e o já 
mencionado VOLP (Vocabulário Ortográfico da Língua Portuguesa).
...
pode-se reduzir a lista para pouco mais de 19 mil verbos no total.
